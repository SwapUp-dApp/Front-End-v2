...
const Dialog = ({
  ...
  setIsOpen?: (open: boolean) => void; // Optional state setter function
  ...
  // Use internal state or controlled state based on props
