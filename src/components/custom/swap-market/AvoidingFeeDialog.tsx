        ...
        <div className="space-y-3" >
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-start">
              <h2 className="font-semibold text-xl" >Bypass fees with subdomain ownership 🚀</h2>
            ...
            <p className="text-base font-medium text-secondary dark:text-su_secondary">Extra functionality for having a subdomain:</p>
          </div>
          ...
          <div className="custom-border-card flex items-start gap-3" >
            ...
            <div>
              <h2 className="text-sm text-primary font-bold text-text dark:text-su_primary" >No SwapUp Fees</h2>
          ...
          <div className="custom-border-card flex items-start gap-3" >
            ...
            <div>
              <h2 className="text-sm text-primary font-bold text-text dark:text-su_primary" >Multichain</h2>
              <p className="text-xs dark:text-su_secondary" >
