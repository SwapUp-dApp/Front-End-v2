  ...
  return (
    <ConnectButton
      ...
      detailsButton={{
        ...
        render: () => (
          <div className="flex flex-col-reverse lg:flex-row lg:items-center gap-3 cursor-pointer" >
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-3 border-[1.5px] border-white/20 p-3 rounded-md" >
              ...
              <span className="flex justify-center lg:justify-start items-center gap-4 lg:gap-2" >
                ...
                <svg className="w-3" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10 2L6 6L2 2" stroke="white" stroke-width="1.5" stroke-linecap="square" />
                </svg>
              </span>
            </div>
      ...
      connectButton={{
        ...
        label: <Button className="w-full h-full text-sm lg:text-base" >Connect Wallet</Button>
      }}
    //auth={{
