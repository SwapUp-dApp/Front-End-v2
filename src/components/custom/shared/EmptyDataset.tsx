...
const EmptyDataset = ({ title, description, children, navigateTo }: IProp) => {
  const navigate = useNavigate();
  return (
    <div className="relative w-full flex justify-center items-center h-[386px]" >
      <img className="absolute top-0 h-full" src="/src/assets/svgs/emptyBackground.svg" alt="" />
      <div className="absolute w-[497px] h-full bg-[rgba(217, 217, 217, 1)]" ></div>
