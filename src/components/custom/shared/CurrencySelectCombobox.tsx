...
interface IProps {
  ...
  value: ICurrency[];
  onChange: (selectedCurrencies: ICurrency[]) => void;
  className?: string;
}
...
const CurrencySelectCombobox: React.FC<IProps> = ({
  ...
  const toggleSelection = (currency: ICurrency) => {
