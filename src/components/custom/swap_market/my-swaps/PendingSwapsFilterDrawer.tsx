...
import { SUT_PendingFiltersStatusType, SUT_FiltersSwapModeType } from "@/types/my-swaps-store.types";
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-su_secondary text-sm font-normal flex items-center justify-between">
                          ...
                          <button onClick={() => { }} type="reset" className="flex items-center gap-2 py-1 px-2 rounded-sm hover:bg-su_active_bg" >
