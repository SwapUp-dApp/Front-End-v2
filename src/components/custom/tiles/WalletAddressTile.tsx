...
const WalletAddressTile = ({ walletAddress, className, children, ...props }: IProp) => {
  return (
    <div className="flex items-center gap-10 xl:gap-20 dark:bg-su_enable_bg py-2 px-3 rounded-xs" >
      <div
        className={cn(
