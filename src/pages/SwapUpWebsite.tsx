import ConnectWalletButton from "@/components/custom/shared/ConnectWalletButton";
...
import { getIsActiveNav, getShortenWalletAddress, getNetworkImageById } from "@/lib/utils";
...
const SwapUpWebsite = () => {
  ...
  // const [connectWallet, wallet] = useProfileStore(state => state.profile.wallet);
                ...
                <div className="flex items-center gap-4" >
                  <div className="border-2 rounded-md py-2 px-4 flex items-center gap-4" >
                    ...
                    <div className="flex items-center gap-4" >
                      ...
                      {/* <p className="capitalize" >{profile..title}</p> */}
