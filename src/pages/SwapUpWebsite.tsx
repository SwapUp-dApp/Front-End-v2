...
const SwapUpPage = () => {
	return (
		<div>
			...
			>
				<LpNavbar />
				<div className="container mx-auto mt-16 sm:px-0 md:px-10">
					...
					<div className="flex justify-center w-full mt-16 pb-16 overflow-x-auto sm:justify-items-start">
						<div className="flex space-x-4 md:space-x-2">
							<LogoButton imgSrc="/assets/images/Ethereum.png" />
							<LogoButton imgSrc="/assets/images/Base.png" />
							<LogoButton imgSrc="/assets/images/Alchemy.png" />
							<LogoButton imgSrc="/assets/images/Solana.png" />
							<LogoButton imgSrc="/assets/images/Polygon.png" />
						</div>
					</div>
				</div>
			</div>
			...
			<div
				className="h-[800px] bg-cover bg-center w-full"
