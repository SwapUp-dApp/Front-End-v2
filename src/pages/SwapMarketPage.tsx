...
const SwapMarketPage = () => {
  ...
  const handleOpenSwapFilterData = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const newOpenSwapFilteredData = openMarketTableData.filter((item) => (
      item.swap_preferences.preferred_asset.type.toLocaleLowerCase().includes(value) ||
      item.owners_wallet.toLowerCase().includes(value) ||
      ...
      <section className="flex flex-col gap-4" >
        ...
        <div className="overflow-x-scroll lg:overflow-hidden" >
         <Tabs defaultValue="open-market" >
            ...
            <TabsContent value="open-market" className="w-full flex flex-col gap-4">              
              {/* Filter Data and Title */}
              <div className="flex items-center justify-between" >
                <h2 className="text-2xl font-medium" >Available Swaps</h2>
                <Input
              ...
              <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="font-semibold px-4" >Owner's wallet</TableHead>
                ...
                <TableBody className="divide-y">
                  {
                    filteredOpenSwapData?.map((data, index) => (
                      <TableRow key={data.unique_trade_id + index}>
                        ...
                        <TableCell className="font-medium px-4">{data.owners_wallet}</TableCell>
                        ...
                        <TableCell className="font-medium px-4">{data.creation_date}</TableCell>
                        <TableCell className="font-medium px-4">{data.expiry_date}</TableCell>
