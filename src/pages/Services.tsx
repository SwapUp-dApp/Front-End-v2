...
const ServicesPage = () => {
					...
					tokens: [
						{
							...
							address: "0xd580a62407b813f408ee58e26d1b4b81fc3dc486",
							type: "ERC721",
							image_url: "/assets/nfts/cool-panada.jpg",
						},
					],
				},
			},
	...
	const closedSwapList = [
		...
		},
		{
			step: "Select",
			instruction:
				"Select yours and counterparties wallet and assets to trade.",
		},
		{
			step: "Confirm",
			instruction:
				"Confirm details of trade and send to counterparty for review.",
		},
		{
			step: "Counter Offer",
			instruction:
				"If any party wants to change swap details this can be done now.",
		},
		{
			step: "Accept",
		...
		},
		{
			step: "Receive",
			instruction:
				"Assets are transferred securely to each wallet at the same time.",
		},
		{
			step: "Complete",
			...
			>
				...
				<div className="container mx-auto mt-16 px-2 md:px-10">
					<div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between mt-4">
						<div className="max-w-[638px] md:mr-8 ">
							...
							<p className="text-su_primary_light mt-6 max-w-[450px] font-Urbanist text-base md:text-lg font-medium leading-relaxed text-left">
								Swap NFT's and Cryptocurrencies peer-to-peer on multiple
								networks.
							</p>
							<div className="mt-8">
								<Button
								...
								<div className="w-full md:w-1/2 flex text-start md:text-start mt-10 align-text-top  ">
									<div className="w-full">
										...
										<p className="text-su_primary_light mt-8 w-full md:max-w-[550px] font-Urbanist text-start md:text-left  md:text-lg font-medium leading-relaxed ">
											The SwapUp process utilizes smart contracts for secure,
											trustless trading of digital assets. Users agree on trade
											terms, and upon final approval, assets are transferred via
											smart contract to designated wallets, ensuring security.
										</p>
										<div className="mt-8">
											<Button
												className="text-md gap-8"
											...
											<div className="w-full">
												<div className="p-8 bg-su_least_bg rounded-2xl opacity-80">
													<h3 className="font-Urbanist font-semibold text-xl text-su_primary mb-3">
														Let's Start With the Initiator Steps
													</h3>
							...
							<div className=" container mx-auto px-2  flex flex-col md:flex-row items-start justify-between py-24  ">
								<div className="w-full md:w-1/2 flex text-start md:text-start mt-10 align-text-top  ">
									<div className="w-full">
										...
										<p className="text-su_primary_light mt-8 w-full md:max-w-[550px] font-Urbanist text-start md:text-left  md:text-lg font-medium leading-relaxed ">
											Explore the myriad possibilities of subdomains and elevate
											your online presence with enhanced functionality. Discover
											how strategic subdomain implementation can streamline user
											journeys, boost engagement, and amplify the impact of your
											web presence.
										</p>
										<div className="mt-8">
								...
								<div className="w-full md:w-1/2 flex text-start md:text-start mt-10 align-text-top  ">
									<div className="w-full">
										...
										<p className="text-su_primary_light mt-8 max-w-[550px] font-Urbanist text-start md:text-left  md:text-lg font-medium leading-relaxed ">
											For our community members, we look to have places they can
											rely on for help, hang out with other swappers, and get
											value out of our exclusive memberships.
										</p>
									</div>
								</div>
								<div className="flex text-start  md:text-start w-full md:w-1/2  mt-10">
											...
											<div className="w-full">
												<Accordion type="single" collapsible>
													<AccordionItem value="item-1">
														...
														<AccordionTrigger className="text-start md:text-start ">
															What benefits does participation in the SwapUp
															loyalty program offer?
														</AccordionTrigger>
														<AccordionContent className="text-su_primary_lighter font-Urbanist text-sm pb-2 md:pb-0  md:mt-2 mb-10">
															Participation in the SwapUp loyalty program allows
															users to receive various bonuses, discounts on
															trading fees, additional rewards, and access to
															exclusive platform features. Additionally, the
															loyalty program may include unique promotions and
															offers for participants, enhancing their overall
															platform experience.
														</AccordionContent>
													</AccordionItem>
												</Accordion>
												<Accordion type="single" collapsible>
													<AccordionItem value="item-1">
														...
														<AccordionContent className="text-su_primary_lighter font-Urbanist text-sm pb-2 md:pb-0  md:mt-2 mb-10">
															Blockchain technology is fundamentally built to be
															a self serving, worldwide engaging solution anyone
															can use. With this more direct and open framework,
															there is a layer of anonymity users appreciate,
															but leads to more risks than needed. We strive to
															build an ecosystem using blockchain technology
															that propels indirect user interoperability
															forward, allowing any diverse set of people to
															interact safely and securely.
														</AccordionContent>
													</AccordionItem>
												</Accordion>
												<Accordion type="single" collapsible>
													<AccordionItem value="item-1">
														...
														<AccordionContent className="text-su_primary_lighter font-Urbanist text-sm pb-2 md:pb-0  md:mt-2 mb-10">
															SwapUp is owned by solopreneur Terin Guerra who
															has been fortunate enough to connect with a few
															great developers over the past few years who
															contribute to the development of this project. The
															team is currently a mix of individuals from many
															parts of the world: USA, Dubai, Brazil, Ukraine.
															The team has a combined 40+years of experience
															launching large scale IT projects for large
															companies.
														</AccordionContent>
													</AccordionItem>
												</Accordion>
												<Accordion type="single" collapsible>
													<AccordionItem value="item-1">
														...
														<AccordionContent className="text-su_primary_lighter font-Urbanist text-sm pb-2 md:pb-0  md:mt-2 mb-10">
															...
															<p className="text-su_primary_lighter font-Urbanist text-sm pb-0 md:pb-0  ml-4  md:mt-2 mb-2">
																• {"   "} Want to bet your friend a pizza he
																couldn’t eat a whole ghost pepper? Put it on the
																blockchain so he can’t skip the tab.
															</p>
															<p className="text-su_primary_lighter font-Urbanist text-sm pb-0 md:pb-0  ml-4  md:mt-2 mb-2">
																•{"   "} Did someone agree to sell you 3 tires
																get 1 free, but pick up the free one next week.
																You like the deal, but don’t know how to keep
																them accountable. You can send them a swapup
																trade and make payment due on delivery of the
																tire.
															</p>
															<p className="h-6">{"   "}</p>
															And on, and on, and on. There are so many use
															cases, we are just getting started
														</AccordionContent>
													</AccordionItem>
												</Accordion>
												<Accordion type="single" collapsible>
													<AccordionItem value="item-1">
														...
														<AccordionContent className="text-su_primary_lighter font-Urbanist text-sm pb-2 md:pb-0  md:mt-2 mb-10">
															Yes, we own the Rune SWAPUP•DAPP•TOKEN. Those who
															own this token are considered owners of the
															company. Each owner has the right to sell their
															tokens at any time, and rewards tied to ownership
															will transfer to the new owner.
															<p className="h-6">{"   "}</p>
															As our platform grows, we will look to expand our
															services and utility to our members. Whether that
															be a token or some other form of utility, that
															will be determined at another time, and
															communicated appropriately.
															<p className="h-6">{"   "}</p>
															Please be wary of any fake token launches claiming
															to be ours.
														</AccordionContent>
													</AccordionItem>
												</Accordion>
												<Accordion type="single" collapsible>
													<AccordionItem value="item-1">
														...
														<AccordionContent className="text-su_primary_lighter font-Urbanist text-sm pb-2 md:pb-0  md:mt-2 mb-10">
															...
															info@swapup.trade. You can also reach us on any of
															our connected social media accounts.e.
														</AccordionContent>
													</AccordionItem>
												</Accordion>
											</div>
