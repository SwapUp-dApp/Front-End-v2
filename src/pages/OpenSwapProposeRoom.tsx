...
const OpenSwapProposeRoom = () => {
  ...
  useEffect(() => {
    if (isSuccess && data) {
      state.setValuesOnProposeOpenSwapRoom(tradeId!, data.data.data as SUI_OpenSwap);
    }
    ...
    <div className="space-y-4" >
      ...
      <div className="grid lg:grid-cols-2 gap-4 mb-16 lg:mb-16" >
        ...
        {isSuccess && state.receiver.profile.walletAddress ?
          <RoomLayoutCard layoutType={"receiver"} counterPartyWallet={state.receiver.profile.walletAddress} roomKey="openRoom" />
          :
