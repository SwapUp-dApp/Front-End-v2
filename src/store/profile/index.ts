  ...
  overviewTab: {
    ...
    subdomainSection: {
      ...
      createNewSubdomain: {
        ...
        resetSwapCreation: () => set(state => resetSubnameCreationProcess(state))
      },
